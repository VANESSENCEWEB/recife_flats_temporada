...
export const APARTAMENTOS = [
  {
    ...
    badge: 'Para família',
    tagline: '5 min da praia — espaço ideal para famílias',
    description:
      'Apartamento com 2 quartos (2 camas de casal), ar-condicionado nos dois quartos, cozinha completa e Wi-Fi. No Edifício Ipê, prédio pequeno e bem localizado em Boa Viagem, a 5 minutos da praia e em cima do comércio do bairro (padaria, mercado). Estacionamento rotativo na área externa do prédio.',
    beds: 2,
    bedrooms: 2,
    guests: 4,
    bathrooms: 1,
    ...
    rating: 4.9,
    reviewCount: 42,
    amenities: ['Wi-Fi', '2 quartos com ar-condicionado', '5 min da praia', 'Pet friendly', 'Estacionamento rotativo', 'Cozinha equipada'],
